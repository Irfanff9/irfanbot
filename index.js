...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6289510497533@s.whatsapp.net`]
...
cmhit.push(command)
  ...
  /*const reply = (teks) => {
    ...
    const textImg = (teks) => {
           return ikyy.sendMessage(from, teks, text, {quoted: freply, thumbnail: fs.readFileSync('./irfan.jpg')})
        }
const math = (teks) => {
           return Math.floor(teks)
       }
/*const reply = (teks) => {
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6289510497533?text=hello`}}})
		}*/
...
const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./irfan.jpg')
        }}}
      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "IRFANFF9", //Kasih namalu
            description: "Irfan",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧",
            productImageCount: 1,
          },
...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `IRFANFF9`, "footerText": "*_𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
             res = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*Irfan*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             xeon.relayWAMessage(res)
        }
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Irfan`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6289510497533?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6289510497533`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6289510497533`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6289510497533`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6289510497533@s.whatsapp.net";
...
await xeon.setStatus(`Bot By IRFANFF9`).catch((_) => _);
...
*Thank you for registering in the 𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧 Database*
...
*「 𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'IRFANFF9', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered 𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧*`)
		}, 2000)
        break
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6289510497533@s.whatsapp.net"
        dtod = '6289510497533'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'bugreport':
              ...
              xeon.sendMessage('6289510497533@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               ...
               buttons = [{buttonId: `sc`,buttonText:{displayText: 'SC BOT'},type:1},{buttonId:`iggw`,buttonText:{displayText:'PM ON WHATSAPP'},type:1}]
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": fs.readFileSync(`./irfan.jpg`),
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧`, [
          {
            buttonId: `command`,
            buttonText: {
...
case 'script':
		case 'sc':
		case 'sourcecode':
		reply ("mau minta esceh banh?")
hem = fs.readFileSync('./media/vn/gani.mp3');
xeon.sendMessage(from, hem, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
     ...
     break
        ...
        case "broadcast":  
                   if (!isOwner && !mek.key.fromMe) return reply('only owner can use this feature')    
					...
					buff = await xeon.downloadMediaMessage(encmedia)
					for (let _ of anu) {
						xeon.sendMessage(_.jid, buff, image, {quoted:fakestatus ,caption: `「  *𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧 BROADCAST* 」\n\n${ini_bc}`})
					}
					reply('```Success Broadcast```')
					} else {
					for (let _ of anu) {
					xeon.sendMessage(_.jid, `*𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧 BROADCAST*\n${ini_bc}`, text, { contextInfo: { mentionedJid: [sender],"forwardingScore":999,"isForwarded":true},sendEphemeral: true })
					}
					reply('```Success Broadcast```')
					}
					break
...
case 'mygithub':
  reply('https://github.com/irfanff9')
					break;
   case 'ss':
      reply(mess.wait)
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 𝗜 𝗥 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧 BROADCASTING 」*\n\n${body.slice(4)}`})
}
...
buff = await xeon.downloadMediaMessage(encmedia)
for (let _ of anu) {
xeon.sendMessage(_.jid, buff, video, { mimetype: Mimetype.gif, quoted: finv, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: `${body.slice(4)}` })
}
reply(`Sukses mengirim Broadcast ${body.slice(4)}`)
} else {
for (let _ of anu) {
...
xeon.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./irfan.jpg')})
break
case  'blowjob':
if (!isGroup) return reply('this feature is only for groups')
if (!isNsfw) return reply(`Nsfw feature is not yet active in this group\nType: ${prefix}nsfw 1 \To activate`)
...
case 'nsfw':
			...
			case 'maker3d': 
					...
					xeon.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./irfan.jpg')})
					break
			case 'maker3d2': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Xeon`)
					makell = args.join(" ")
...
buttons = [{buttonId: `pinterest`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝗜 ?? 𝗙 𝗔 𝗡 𝗕 𝗢 𝗧', imageMessage: imageMsg,
              contentText:`ɴᴏᴛᴇ: ʜᴏʀɴʏ = ʙᴏɴᴋs`,buttons,headerType:4}
              prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              xeon.relayWAMessage(prep)
        break;
...
*[Wait] Wait a moment..*`
      ...
      case "tomp4":
        ...
        case 'tts':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (args.length < 1) return reply(`*Contoh : ${prefix + command} kodebahasa text*`)
            
					  try{
        if (args.length > 1) {
        const gtts = require('./lib/gtts')(args[0])
        if (args.length < 2) return xeon.sendMessage(from, 'Textnya mana gan?', text, {quoted: mek})
        ngab = budy.slice(7)
        ranm = getRandom('.mp3')
        rano = getRandom('.ogg')
        ngab.length > 600
